...
<div class="topnav">
  ...
  <a href="Home.jsp">Log out</a> 
   ...
   <form action="updatesche" method="post">
   
   			Appointment ID<input type="text" name="scheappointmentid" value="<%= appointmentid %>" readonly><br>
   			Doctor Name<input type="text" name="docname" value="<%= doctorname %>"><br>
   			Patient Name<input type="text" name="patname" value="<%= patientname %>" readonly><br>
        	Appointment Date<input type="text" name="date" value="<%= date %>"><br>
        	Appointment Time<input type="text" name="time" value="<%= time %>"><br>
