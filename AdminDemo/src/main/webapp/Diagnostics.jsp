...
<div class="d1">
	<a href="#">
		 <button class="button1">Create Schedule</button>
		
	</a>
	<br><br>
	<a href="schedule.jsp">
		 <button class="button1">View Schedule</button>
	...
	<br><br>
	<a href="#">
		 <button class="button1">View Payment info</button>
		
	</a>
	<br><br>
	<a href="#">
		 <button class="button1">Create Diagnostic Report</button>
